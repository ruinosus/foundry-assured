...
- [x] F09 [AFK] Conformidade honesta por fase — deps: F03, F04, F07, F08 — US: US-011 — sec: auth, input-validation, logs → F09.md
...
- [x] F14 [AFK] Redesign Assured UI das rotas legadas — deps: F01, F02 — US: US-002, US-018 — sec: auth, input-validation, logs, dados-sensiveis → F14.md
