...
description: Invocations-based hosted packaging of the platform concierge, including toolbox binding, parity goals, and current infra-gated verification gaps.
tags: [hosted-agents, platform, invocations, mcp]
---
