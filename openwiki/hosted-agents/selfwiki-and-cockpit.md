...
title: Hosted selfwiki and cockpit agents
description: Grounded hosted-agent containers for selfwiki and cockpit, including their shared Responses-based packaging and KB-backed behavior.
tags: [hosted-agents, selfwiki, cockpit, grounded]
---
