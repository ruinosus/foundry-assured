...
description: "Next.js route handlers that proxy backend services and CopilotKit traffic, including token forwarding, catch-all admin and tenant proxies, and the runtime coupling they create."
