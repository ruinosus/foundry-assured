...
description: Next.js frontend architecture for Foundry Assured, including shell composition, domain registry, auth setup, demo mode, and the workspace pages that sit around the shared assurance console.
tags: [frontend, nextjs, copilotkit, msal]
---
