---
type: frontend-console
title: Domain console
description: Shared frontend console for all AI domains, including CopilotKit runtime wiring, auth token flow, hosted toggles, workflow widgets, and evidence rendering.
tags: [frontend, console, domains, copilotkit]
---
...
- [Backend grounded domains](../backend/grounded-domains.md)
