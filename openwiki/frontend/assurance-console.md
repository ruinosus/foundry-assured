...
description: Shared domain console for all agents, combining CopilotKit chat, workflow and approval widgets, live-versus-hosted switching, and evidence rendering.
tags: [frontend, console, copilotkit, evidence]
---
