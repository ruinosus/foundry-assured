...
description: "Unified CopilotKit-based domain console that adapts to grounded, workflow, tool, and graph runtimes, including evidence rendering and hosted/live mode switching."
