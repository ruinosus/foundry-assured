---
type: ui-guide
title: Admin, evaluations, and tickets pages
description: Workspace-facing frontend pages for operational data and admin control, including role-based visibility, backend dependencies, and how each page maps to a backend API family.
