...
title: Infrastructure identity and access
description: Identity model across frontend, backend, Graph, hosted agents, and Azure resources, including app roles, OBO prerequisites, and managed identities.
tags: [infrastructure, identity, access, entra]
---
