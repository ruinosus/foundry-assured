...
The README describes the user-visible routes that hang off this frontend surface, such as `/d/helpdesk`, `/d/selfwiki`, `/d/oncall`, `/d/deepcall`, `/d/platform`, `/tickets`, `/evals`, and `/admin/users`. [`README.md#L21-L33`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/README.md#L21-L33)

Operationally, the frontend is a **consumer of backend AG-UI endpoints**, not a consumer of MCP. The repo README says the frontend is CopilotKit over AG-UI and separately describes the MCP server as a machine-facing surface for MCP clients. [`README.md#L12-L16`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/README.md#L12-L16) [`README.md#L98-L115`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/README.md#L98-L115) The dedicated MCP README reinforces the boundary by documenting that the MCP app no longer has CORS because the frontend talks to the backend, not directly to MCP. [`apps/mcp/README.md#L254-L266`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/apps/mcp/README.md#L254-L266)
