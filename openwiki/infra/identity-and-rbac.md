...
title: Identity and RBAC model
description: Azure identity and RBAC relationships across Foundry, Search, Storage, Container Apps, hosted agents, and OBO user flows.
tags: [infra, identity, rbac, security]
---

Identity and RBAC are central to the repository design because the system tries to stay keyless wherever possible and because both live user OBO and hosted-agent execution depend on correctly layered Azure permissions.[`README.md`](https://github.com/ruinosus/foundry-assured/blob/4b749e7bac56789f0b1097cd4a8212b5c5c65d05/README.md#L41-L45) [`infra/resources.bicep`](https://github.com/ruinosus/foundry-assured/blob/4b749e7bac56789f0b1097cd4a8212b5c5c65d05/infra/resources.bicep#L67-L76)
