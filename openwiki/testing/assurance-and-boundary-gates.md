...
Together these are the main change-safety signals for modular-monolith refactors described in the runtime topology page: the system keeps shared seams such as the domain catalog stable while resisting accidental new cross-module reach-through. [`runtime-topology.md`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/openwiki/architecture/runtime-topology.md#L95-L108)
...
In practice, these gates protect the composition-root boundaries documented in the runtime topology page: the backend must keep mounting domain routes correctly, while MCP remains a separate composition root rather than being silently reintroduced into backend routing. [`runtime-topology.md`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/openwiki/architecture/runtime-topology.md#L82-L93) [`runtime-topology.md`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/openwiki/architecture/runtime-topology.md#L97-L108)
...
This is the gate family that keeps the citation discipline required by the grounded-answer and evidence flow honest: model-facing documentation must remain source-auditable rather than becoming a stale or hallucinated secondary corpus. [`tenancy-areas-and-access-control.md`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/openwiki/concepts/tenancy-areas-and-access-control.md#L114-L128)
...
This is the executable version of the MCP server contract described in the integration page: MCP remains a separate machine-facing surface, but it still reuses shared tenancy and authorization policy rather than inventing its own. [`mcp-server-surface.md`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/openwiki/integrations/mcp-server-surface.md#L73-L85)
...
This gate family is the executable counterpart to the authoring/publication access model: publication is area-scoped, approval-bound, and designed to materialize only already approved content through sanitized, idempotent adapters. [`tenancy-areas-and-access-control.md`](https://github.com/ruinosus/foundry-assured/blob/18595cf77fa56dad04a5e646bc5dae9bcae7f6fa/openwiki/concepts/tenancy-areas-and-access-control.md#L77-L97)
