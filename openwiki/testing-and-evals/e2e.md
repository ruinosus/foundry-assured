...
description: Playwright E2E coverage for the deployed cloud app, including Entra sign-in, MFA automation, domain walkthroughs, hosted toggles, diagnostics, and artifact capture.
tags: [testing, e2e, playwright, entra]
---
