---
type: api-guide
title: Admin and operational APIs
description: Backend HTTP APIs for admin management, user-role operations, tickets, evals, health, and caller identity, including their owning services and operational side effects.
tags: [backend, api, admin, operations]
---
