---
type: subsystem
title: Knowledge pipeline and docbundle contract
description: Backend-owned ingestion, wiki adaptation, schema validation, and bundle generation paths that feed the grounded domains.
tags: [backend, knowledge, ingest, docbundle]
---
