---
type: backend-platform-domain
title: Platform domain
description: The tool-driven backend domain for engineering operations, including live per-request tool brokering, hosted bridging, and approval-aware constraints.
tags: [backend, platform, tools, mcp]
---
...
- [Hosted platform](../hosted-agents/platform-hosted.md)
