...
title: Operations and runtime behavior
description: Global runtime settings, startup and shutdown lifecycle, hosted-client caching, operational endpoints, persistence locations, and known runtime caveats in apps/backend.
tags: [backend, operations, runtime, settings]
---
