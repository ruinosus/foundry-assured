...
description: How apps/backend authenticates callers, exchanges OBO credentials, resolves tenants, enforces roles and domain entitlements, and persists tenant records.
