...
title: Platform tools and RBAC
description: MCP server registry, tenant connection overlays, internal versus hosted tool construction, and the fail-closed authorization model behind the platform domain.
tags: [backend, platform, mcp, rbac]
---
