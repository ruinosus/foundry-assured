...
description: The live helpdesk domain is the backend’s multi-agent workflow over AG-UI, combining triage, retrieval, resolution, per-user memory, and human-approved ticket escalation.
