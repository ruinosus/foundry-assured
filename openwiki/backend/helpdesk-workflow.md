...
description: The multi-agent helpdesk workflow, its per-request identity and memory model, HITL escalation, and the stream-ordering workaround required by the AG-UI adapter.
