...
([docs/CASE-STUDY-LLM-WIKI-LOOP.md:12-17](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-LLM-WIKI-LOOP.md#L12-L17)).
...
subiu é o achado
([CASE-STUDY-LLM-WIKI-LOOP.md:55-64](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-LLM-WIKI-LOOP.md#L55-L64)):

| Passo | O que mudou | Score | Fonte |
| --- | --- | --- | --- |
| Baseline | docs LLM-summarized + golden LLM-authored | 12/20 | [LLM-WIKI-LOOP.md:62](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-LLM-WIKI-LOOP.md#L62) |
| Source-verify o **golden** | ~5 "falhas" eram **bugs do golden** (o agente estava certo) | 16/20 | [LLM-WIKI-LOOP.md:63](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-LLM-WIKI-LOOP.md#L63) |
| Instrução de autoridade | preferir docs de arquitetura autoritativos sobre resumos | 17/20 | [LLM-WIKI-LOOP.md:64](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-LLM-WIKI-LOOP.md#L64) |
...
([LLM-WIKI-LOOP.md:65-71](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-LLM-WIKI-LOOP.md#L65-L71)).
...
mente
([docs/CASE-STUDY-SELFWIKI-DOGFOOD.md:11-21](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-SELFWIKI-DOGFOOD.md#L11-L21)).
...
- **Bug 1 — contagem de citação.** O gate de fidelidade media *qual fração das citações de
  ...
  **Toda citação `.json`/`.tsx` falhava silenciosamente.** Fix: ordenar
  ...
  ([SELFWIKI-DOGFOOD.md:47-61](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-SELFWIKI-DOGFOOD.md#L47-L61)).
- **Bug 2 — escopo cross-area.** O bundle `docs/` pontuou **71%** — mas uma wiki de
  ...
  ([SELFWIKI-DOGFOOD.md:63-69](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-SELFWIKI-DOGFOOD.md#L63-L69)).
...
([SELFWIKI-DOGFOOD.md:79-94](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-SELFWIKI-DOGFOOD.md#L79-L94)):
...
O agente
[apps/backend/app/agents/selfwiki.py](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/apps/backend/app/agents/selfwiki.py)
...
([SELFWIKI-DOGFOOD.md:91-94](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-SELFWIKI-DOGFOOD.md#L91-L94)).
A geração é dirigida por
[apps/backend/app/knowledge/wiki_builder.py](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/apps/backend/app/knowledge/wiki_builder.py),
...
| Deck | Para quê | Fonte |
| --- | --- | --- |
| `saas-architecture.html` | A arquitetura SaaS visual (control plane × data plane, stamps) | [docs/saas-architecture.html](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/saas-architecture.html) |
| `saas-request-flow.html` | O fluxo de requisição multi-tenant ponta-a-ponta | [docs/saas-request-flow.html](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/saas-request-flow.html) |
| `grounded-citations-explainer.html` | **Novo** — citações grounded + ACL por usuário (funcional → técnico → Microsoft) | [docs/grounded-citations-explainer.html](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/grounded-citations-explainer.html) |
| `deep-wiki-presentation.html` | Como a deep-wiki é construída, ingestada e seu custo (dados reais) | [docs/README.md:34](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/README.md#L34) |
| `fluxo-deepwiki.html` | Build-time (fidelity gate) × query-time (identity trim) | [docs/README.md:35](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/README.md#L35) |
...
([docs/PRESENTATIONS-PORTAL-PLAN.md:16-25](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/PRESENTATIONS-PORTAL-PLAN.md#L16-L25)).
...
> ([docs/PRESENTATIONS-PORTAL-PLAN.md:10-14](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/PRESENTATIONS-PORTAL-PLAN.md#L10-L14)).
...
do allowed-set
([docs/PRESENTATIONS-PORTAL-PLAN.md:26-46](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/PRESENTATIONS-PORTAL-PLAN.md#L26-L46)).
...
([docs/PRESENTATIONS-PORTAL-PLAN.md:157-164](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/PRESENTATIONS-PORTAL-PLAN.md#L157-L164)).
...
([SELFWIKI-DOGFOOD.md:130-135](https://github.com/ruinosus/foundry-assured/blob/3333d60d0e9c02b64a532f2c9bad94692cf50075/docs/CASE-STUDY-SELFWIKI-DOGFOOD.md#L130-L135)).
