...
For integrated validation, run the frontend and backend together or use the E2E suite documented in End-to-end and validation.

## Related pages

- Frontend domain console
- Frontend admin, evals, and tickets
- Frontend demo mode
