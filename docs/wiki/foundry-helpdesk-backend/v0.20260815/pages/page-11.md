...
That order replaces the older pattern of handwritten template overrides. It is why the workflow and domain agents can all share the same declarative source system while still having common persona and guardrail behavior. README.md
