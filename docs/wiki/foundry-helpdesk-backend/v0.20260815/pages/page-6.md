...
The canonical overview in source is `apps/backend/eval/README.md`, and the main runner is [`apps/backend/eval/run_eval.py`](../../apps/backend/eval/run_eval.py).
...
- Backend evaluations and tickets
