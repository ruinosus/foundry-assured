...
| ✅ **Foundry IQ knowledge base + agentic retrieval** (`AzureAISearchContextProvider`, `mode="agentic"`) | `app/modules/grounded/internal/cockpit.py`, `selfwiki.py`, ingest scripts | [Connect agents to Foundry IQ KBs](https://learn.microsoft.com/en-us/azure/ai-foundry/agents/how-to/tools/knowledge-retrieval?view=foundry) |
