...
description: "Next.js application structure, route model, auth/bootstrap providers, domain registry, and the main user-facing surfaces that sit above the backend and hosted-agent runtimes."
